...
DESCRIPTION=""
SRC_URI="
https://download.savannah.gnu.org/releases/freetype/freetype-2.14.1.tar.xz -> freetype-2.14.1.tar.xz
utils? ( https://download.savannah.gnu.org/releases/freetype/ft2demos-2.14.1.tar.xz -> freetype-2.14.1-ft2demos.tar.xz )"
LICENSE="|| ( FTL GPL-2+ )"
SLOT="2"
KEYWORDS="*"
